      ...
      <div className="welcome-section">
        ...
        <div className="welcome-images">
          ...
          <div className="image-container">
            <img src="./our_data/special_memories/simple_images/flower.jpg" alt="flower" />
          </div>

          <div className="image-container">
            <img src="./our_data/special_memories/simple_images/received_1104838777077504.jpeg" alt="us_stickfigure_version" />
          </div>
